...
import ToyShop.model.BuyersModel;
import ToyShop.model.DrawingModel;
import ToyShop.model.ToysModel;
import ToyShop.view.BuyersView;
import ToyShop.view.ToysView;
...
public class Menu {
    ...
    public boolean BuyerAddNew() {
        ...
        System.out.print("ФИО (на инглише): ");
        try {
