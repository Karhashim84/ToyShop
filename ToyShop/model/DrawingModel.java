...
import ToyShop.classes.Drawing;
import ToyShop.classes.Prize;
import ToyShop.classes.PrizeAwarded;
...
public class DrawingModel {
    ...
    public DrawingModel() {
        fnamePrizesToAward = "./ToyShop/db/prizestoaward.csv";
        fnamePrizesAwarded = "./ToyShop/db/prizesawarded.csv";
        drw = new Drawing();
